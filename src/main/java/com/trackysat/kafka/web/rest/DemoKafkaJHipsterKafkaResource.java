...
@RestController
@RequestMapping("/api/demo-kafka-j-hipster-kafka")
public class DemoKafkaJHipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DemoKafkaJHipsterKafkaResource.class);
    ...
    public DemoKafkaJHipsterKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
